 ...
 * https://github.com/iamironrabbit/monlam-dictionary/blob/9ef520a/app/src/main/assets/MLDic.ml
 * which is licensed under GPLv3.
 *
 * The word list below is an excerpt of the original list.
 *
 * ```sql
 * select word, definition from tben
 * where word not like '% %'
 * and length(word) < 15
 * and definition regexp '^[a-z ]{0,20}$';
 * ```
 */
